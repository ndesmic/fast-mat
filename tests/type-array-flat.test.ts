...
Deno.test("Adds 4x4", () => {
	...
	const resultF32Flat = addMatrixFloat32Flat({ shape: [4,4], data: mat4AF32 }, { shape: [4,4], data: mat4BF32 });
...
Deno.test("Adds 128x128", () => {
	const resultF64Flat = addMatrixFloat64Flat({ shape: [128,128], data: mat128AF64 }, { shape: [128,128], data: mat128BF64 });
	const resultF32Flat = addMatrixFloat32Flat({ shape: [100,100], data: mat128AF32 }, { shape: [100,100], data: mat128BF32 });
	const resultI32Flat = addMatrixInt32Flat({ shape: [128,128], data: mat128AI32 }, { shape: [128,128], data: mat128BI32 });
	

	assertEquals(resultF64Flat.data, mat128ResultF64);
	assertEquals(resultF32Flat.data, mat128ResultF32);
